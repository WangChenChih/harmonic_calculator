...
## 人工泛音
以二胡為例，人工泛音的產生方式通常為一指按實音，而用四指虛按某特定處。原理是因為「一指與四指之間的距離」與「四指至琴碼的距離」成簡單整數比，使得駐波可以一指與琴碼間產生，而四指則負責為強制波節點。今天假設「千斤至琴碼之距離」為 $L$ 、「食指至千斤之距離」為 $L'$ 、「食指與四指之間的距離」為 $l$，並假設食指與四指之間只含有一個波腹，則需要滿足以下方成組
